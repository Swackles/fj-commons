...
public enum TestEnum {
    ...
    private static final Function<String, Optional<TestEnum>> ADVANCED_LOOKUP = QuickSearch.build(
            TestEnum.class,
            testEnum -> new String[]{
    ...
    static final Function<String, Optional<TestEnum>> BASIC_LOOKUP = QuickSearch.build(TestEnum.class);
